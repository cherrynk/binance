...
def download_full_klines(symbol, interval, start, end=None, save_to=None, req_interval=None, dimension="ohlcv"):
    ...
    df = pd.DataFrame(np.array(data), columns=cols, dtype=np.float32)
...
if __name__ == '__main__':
    ...
    download_full_klines(symbol="BTC/USDT", interval="1m", start="2019-01-01", end="2019-12-31",
                         save_to="/Users/nikan/Downloads/btc_history_y2019_1m.csv")